...
const Scalar PRETO = Scalar(0.0, 0.0, 0.0);
const Scalar BRANCO = Scalar(255.0, 255.0, 255.0);
const Scalar AMARELO = Scalar(0.0, 255.0, 255.0);
const Scalar VERDE = Scalar(0.0, 200.0, 0.0);
const Scalar VERMELHO = Scalar(0.0, 0.0, 255.0);
